# Generated by Django 4.2.3 on 2025-09-13 19:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resume_template', models.ForeignKey(help_text='Resume template this project belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='projects', to='job_tracker.resumetemplate')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resume_template', models.ForeignKey(help_text='Resume template this experience belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='experiences', to='job_tracker.resumetemplate')),
            ],
            options={
                'ordering': ['-order', '-start_date'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resume_template', models.ForeignKey(help_text='Resume template this education belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='educations', to='job_tracker.resumetemplate')),
            ],
            options={
                'ordering': ['-order', '-start_date'],
